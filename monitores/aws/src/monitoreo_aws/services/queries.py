...
DETAIL_QUERIES = {
    ...
    "mensajeria_errores_por_hora": """fields @timestamp | filter (ispresent(Httpcode) and Httpcode != 200) or LogLevel = 'Error' | stats count(*) as count by bin(1h) as hora | sort hora asc""",
